...
# 
# group t.me/MoeKernel
# channel t.me/MoeNOfficial
# ----- By @whyakari -----
##
...
add_prop_as_ini to_module_prop "name" "$device_name - Pixel-Props"
...
add_prop_as_ini to_module_prop "author" "whyakari"
add_prop_as_ini to_module_prop "description" "Fingerprint Props - $device_name - ($(date --date="$device_build_security_patch" +%b) $(date --date="$device_build_security_patch" +%Y))"
add_prop_as_ini to_module_prop "donate" "https://ko-fi.com/moenyan"
add_prop_as_ini to_module_prop "support" "t.me/whyakari"
